...
public class SingleFilePageSwapper implements PageSwapper
{
            ...
            long startFilePageId, Page[] pages, int arrayOffset, int length ) throws Exception
    {
        ...
        StoreFileChannel channel = unwrappedChannel( startFilePageId );
    ...
    private long lockPositionReadVector(
            long filePageId, StoreFileChannel channel, long fileOffset, ByteBuffer[] srcs ) throws IOException
    {
        try
        {
    ...
    private StoreFileChannel unwrappedChannel( long startFilePageId )
    {
    ...
    private Object positionLock( StoreFileChannel channel )
    {
        ...
        {
            throw new LinkageError( "No getter for StoreFileChannel.positionLock", th );
        }
    }
    ...
    private synchronized void tryReopen( long filePageId, ClosedChannelException closedException ) throws ClosedChannelException
    {
        ...
        try
        {
            ...
            {
                // The closing of a StoreFileChannel also releases all associated file locks.
                acquireLock();
            }
        }
        catch ( IOException e )
