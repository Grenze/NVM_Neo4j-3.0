...
{
    private final FileSystemAbstraction fileSystem = new org.neo4j.io.fs.DefaultFileSystemAbstraction();
    ...
    public ServerControls newServer()
    {
        ...
        try
        {
            logOutputStream = createOrOpenAsOuputStream( logFileSystem, new File( serverFolder, "neo4j.log" ), true );
        }
        catch ( IOException e )
        {
