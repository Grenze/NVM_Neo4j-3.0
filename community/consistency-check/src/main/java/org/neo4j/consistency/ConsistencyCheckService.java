...
import org.neo4j.consistency.statistics.*;
...
import static org.neo4j.logging.org.neo4j.logging.fs.Files.createOrOpenAsOuputStream;
...
public class ConsistencyCheckService
{
            ...
            throws ConsistencyCheckIncompleteException, IOException
    {
        return runFullConsistencyCheck( storeDir, tuningConfiguration, progressFactory, logProvider,
                new org.neo4j.io.fs.DefaultFileSystemAbstraction(), verbose );
    }
    ...
    private final org.neo4j.logging.org.neo4j.logging.fs.DefaultFileSystemAbstraction logFileSystem = new org.neo4j.logging.org.neo4j.logging.fs.DefaultFileSystemAbstraction();
            ...
            throws ConsistencyCheckIncompleteException
    {
        ...
        Log reportLog = new ConsistencyReportLog( Suppliers.lazySingleton( () -> {
            try
            {
                ...
                return new PrintWriter( createOrOpenAsOuputStream( logFileSystem, reportFile, true ) );
            }
            catch ( IOException e )
            {
        ...
        try ( NeoStores neoStores = factory.openAllNeoStores() )
        {
            ...
            try
            {
                ...
                labelScanStore = new LuceneLabelScanStoreBuilder( storeDir, indexStoreView, (org.neo4j.logging.org.neo4j.logging.fs.FileSystemAbstraction) fileSystem,
                        consistencyCheckerConfig, operationalMode, logProvider )
                        .build();

                SchemaIndexProvider indexes = new LuceneSchemaIndexProvider((org.neo4j.logging.org.neo4j.logging.fs.FileSystemAbstraction) fileSystem, DirectoryFactory.PERSISTENT,
