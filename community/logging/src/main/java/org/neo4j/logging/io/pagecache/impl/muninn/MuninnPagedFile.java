 ...
 */
package org.neo4j.logging.io.pagecache.impl.muninn;
...
import org.neo4j.logging.io.pagecache.IOLimiter;
import org.neo4j.logging.io.pagecache.PageCursor;
import org.neo4j.logging.io.pagecache.PageEvictionCallback;
import org.neo4j.logging.io.pagecache.PageSwapper;
import org.neo4j.logging.io.pagecache.PageSwapperFactory;
import org.neo4j.logging.io.pagecache.PagedFile;
import org.neo4j.logging.io.pagecache.impl.PagedReadableByteChannel;
import org.neo4j.logging.io.pagecache.impl.PagedWritableByteChannel;
import org.neo4j.logging.io.pagecache.tracing.FlushEvent;
import org.neo4j.logging.io.pagecache.tracing.FlushEventOpportunity;
import org.neo4j.logging.io.pagecache.tracing.MajorFlushEvent;
import org.neo4j.logging.io.pagecache.tracing.PageCacheTracer;
import org.neo4j.logging.io.pagecache.tracing.PageFaultEvent;
...
final class MuninnPagedFile implements PagedFile
{
    private static final int translationTableChunkSizePower = Integer.getInteger(
            "org.neo4j.logging.io.pagecache.impl.muninn.MuninnPagedFile.translationTableChunkSizePower", 12 );
