...
class KeyValueWriter implements Closeable
{
    ...
    static abstract class Writer
    {
        ...
        static Writer create( FileSystemAbstraction fs, PageCache pages, File path, int pageSize ) throws IOException
        {
            if ( pages == null )
            {
                return new StreamWriter( fs.open( path, "wr" ) );
            ...
            {
                return new OpeningStreamWriter( fs.open( path, "wr" ), pages, path, pageSize );
    ...
    {
        private final StoreChannel out;

        StreamWriter( StoreChannel out )
        {
            this.out = out;
        }
    ...
    private static class OpeningStreamWriter extends StreamWriter
    {
        ...
        OpeningStreamWriter( StoreChannel out, PageCache pages, File path, int pageSize )
        {
            super( out );
            this.pages = pages;
            this.path = path;
