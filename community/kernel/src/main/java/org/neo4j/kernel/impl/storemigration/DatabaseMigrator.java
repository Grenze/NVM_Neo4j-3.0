...
public class DatabaseMigrator
{
    ...
    /*public void migrate(File storeDir)
    {
        ...
        StoreMigrationParticipant schemaMigrator = schemaIndexProvider.storeMigrationParticipant( new org.neo4j.logging.org.neo4j.logging.fs.DefaultFileSystemAbstraction(), pageCache,
